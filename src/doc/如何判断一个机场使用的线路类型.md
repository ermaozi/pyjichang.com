...
description: 介绍如何结合 Traceroute 路由追踪、IP 与 ASN 查询、延迟及晚高峰测试，辅助判断机场使用的 IPLC、IEPL、CN2、BGP 中转或普通公网线路。
lastUpdated: true
...
>
> 主站原文：[https://www.ermao.net/article/r50bpg9j/](https://www.ermao.net/article/r50bpg9j/)
...
- 本页事实基准来自[二毛主站原文](https://www.ermao.net/article/r50bpg9j/)，同步时保留主站的更新时间与风险结论。
